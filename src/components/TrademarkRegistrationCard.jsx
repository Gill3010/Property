...
const TrademarkRegistrationCard = () => {
  return (
    <div className="relative w-full max-w-md bg-gray-900/95 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl overflow-hidden p-6 sm:p-8">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 tracking-wide">
            Te ayudamos a posicionar y proteger la identidad de tus productos o servicios.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6 text-white">
        {/* Marca */}
        {/* <div>
          <h3 className="text-lg font-semibold text-purple-300 mb-2">Marca</h3>
          <ul className="list-disc list-inside space-y-1 text-sm text-gray-200">
            <li>
              <strong>Completa:</strong> Propuesta y mejora del nombre, diseño de logotipo, clasificación Niza, preparación y gestión del expediente.
            </li>
            <li>
              <strong>Trámite:</strong> Si ya cuentas con nombre y logotipo, revisamos los documentos, brindamos observaciones y asesoría en el registro.
            </li>
          </ul>
        </div> */}
        ...
        {/* Lema Comercial */}
        {/* <div>
          <h3 className="text-lg font-semibold text-purple-300 mb-2">Lema Comercial</h3>
          <ul className="list-disc list-inside space-y-1 text-sm text-gray-200">
            <li>
              <strong>Completa:</strong> Propuesta de frases publicitarias asociadas a una marca registrada o en trámite.
            </li>
            <li>
              <strong>Trámite:</strong> Registro del lema ya definido, vinculado a una marca existente.
            </li>
          </ul>
        </div> */}
      </div>
...
export default TrademarkRegistrationCard;