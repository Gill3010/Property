      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 tracking-wide">
            Te ayudamos a determinar si tu invención puede ser patentada antes de iniciar el registro.
          </p>
        </div>
      </div>
      ...
      {/* <div className="space-y-6 text-white">
        <div>
          <ul className="list-disc list-inside space-y-1 text-sm text-gray-200">
            <li>Análisis de novedad, nivel inventivo y aplicabilidad.</li>
            <li>Informe técnico con opinión experta.</li>
            <li>Recomendaciones sobre el tipo de protección más adecuada.</li>
          </ul>
        </div>
      </div> */}
