...
const PlantVarietyCertificateCard = () => {
  return (
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 tracking-wide">
            Protege nuevas variedades vegetales que cumplen criterios de novedad, distinción, homogeneidad y estabilidad (DHE).
          </p>
        </div>
      </div>
      ...
      {/* <div className="space-y-6 text-white">
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-gray-200">
            <li>Revisión de criterios de novedad, distinción, homogeneidad y estabilidad.</li>
            <li>Acompañamiento en la elaboración del expediente.</li>
            <li>Gestión para obtener el certificado.</li>
...
export default PlantVarietyCertificateCard;