...
const IntellectualPropertyTrainingCard = () => {
  return (
    <div className="relative w-full max-w-md bg-gray-900/95 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl overflow-hidden p-6 sm:p-8">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400">
            Capacitación en Propiedad Intelectual e Investigación
          </h2>
          <p className="text-sm text-gray-300 tracking-wide">
            Modalidad virtual con sesiones personalizadas para instituciones o equipos de investigación.
          </p>
        </div>
      </div>
      ...
      {/* <div className="space-y-6 text-white">
        <ul className="list-disc list-inside space-y-1 text-sm text-gray-200">
          <li>Contenido: sistema de PI, tipos de protección, beneficios, gestión de registros.</li>
          <li>Duración: hasta 15 días.</li>
          <li>Entregable: informe con asistencia, materiales usados y grabación de la sesión.</li>
        </ul>
      </div> */}
...
export default IntellectualPropertyTrainingCard;